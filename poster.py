...
if __name__ == "__main__":
    # parser должен быть с отступом ровно в 4 пробела от 'if'
    ...
    # Эта строка 'args = parser.parse_args()' (которая является строкой 571 в вашей ошибке)
    # ДОЛЖНА иметь отступ ровно в 4 пробела, выравниваясь с 'parser = ...' выше.
    args = parser.parse_args()

    # Этот вызов 'asyncio.run' также должен иметь отступ ровно в 4 пробела.
    asyncio.run(main(
